...
import { Button, Card, Col, Row, Nav, Table, ProgressBar, Form, ListGroup } from "react-bootstrap";
      ...
      <div className="main main-app p-3 p-lg-4">
        <div className="d-md-flex align-items-center justify-content-between mb-4">
          <div>
            <ol className="breadcrumb fs-sm mb-1">
              ...
              <li className="breadcrumb-item active" aria-current="page">HR Portal</li>
            </ol>
        ...
        <Row className="g-3">
          ...
          <Col md="5" xl="4">
            {/* <Card className="card-one">
              <Card.Header>
                <Card.Title as="h6">Current Timing</Card.Title>
                <Nav className="nav-icon nav-icon-sm ms-auto">
                  <Nav.Link href=""><i className="ri-refresh-line"></i></Nav.Link>
                  <Nav.Link href=""><i className="ri-more-2-fill"></i></Nav.Link>
                </Nav>
                ...
                <Row className="g-3 row-cols-auto align-items-center">
                  <Col>
                    <div className="apex-donut-one">
                      ...
                      <div>
                        <h4 className="ff-numerals text-dark mb-0">100%</h4>
                        <span className="fs-xs text-secondary">Reached</span>
                      </div>
                    </div>
                  </Col>
                  <Col xs="6" xl="7">
                    <h2 className="card-value mb-3">Total Days</h2>
                ...
                <Row className="g-3 row-cols-auto align-items-center">
                  <Col>
                    <div className="apex-donut-one">
                      ...
                      <div>
                        <h4 className="ff-numerals text-dark mb-0">50%</h4>
                        <span className="fs-xs text-secondary">Reached</span>
                      </div>
                    </div>
                  </Col>
                  <Col xs="6" xl="7">
                    <h2 className="card-value mb-3">Left Days</h2>
                    <h6 className="card-label text-dark fw-semibold mb-1">Total left days</h6>
                    <p className="fs-sm text-secondary mb-0">The average time taken to resolve complaints.</p>
                  </Col>
                </Row>
              </Card.Body>
            ...
            <Card className="card-one">
              ...
              <Card.Body>
                ...
                <Table className="mb-0">
                  ...
                  <tbody>
                    <tr>
                      <td>Fri, 20 - Sat, 21 Oct 2023	</td>
                      <td>Devopsdays Bengaluru	</td>
                      <td>Bengaluru</td>
                    </tr>
                    <tr>
                      <td>Fri, 29 Sep 2023	</td>
                      <td>CFO Next	</td>
                      <td>Chennai</td>
                    </tr>
                    <tr>
                      <td>Thu, 05 Oct 2023	</td>
                      <td>Qualys Security Conference</td>
                      <td>Mumbai</td>
                    </tr>
                    <tr>
                      <td>Mon, 09 - Tue, 10 Oct 2023</td>
                      <td>Content India Show</td>
                      <td>Ahemdabad</td>
                    </tr>
                    <tr>
                      <td>wed, 11 Oct 2023</td>
                      <td>Content India Show</td>
                      <td>Ahemdabad</td>
                    </tr>
                  </tbody>
