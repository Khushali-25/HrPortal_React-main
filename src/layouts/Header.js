...
import { faUserPlus } from "@fortawesome/free-solid-svg-icons"; // Replace with the desired FontAwesome icon
  ...
  return (
    <div className="header-main px-3 px-lg-4">
      ...
      <select onChange={handleOptionSelect}>
        ...
        <option value="2">khushali</option>
        <option value="3">Richa</option>
        <option value="3">Richa</option>
        <option value="3">Asmita</option>
