        ...
        return (
            <div className="sidebar">
                <div className="sidebar-header">
                    <Link to="/dashboard/helpdesk" className="sidebar-logo"><img src="/payroll.png" style={{ width: "50px" }} /></Link>
                </div>
    ...
    render() {
        return (
            <React.Fragment>
                ...
                <div className="nav-group show">
                    <div className="nav-label" onClick={this.toggleMenu}>Employee</div>
                    {this.populateMenu(applicationsMenu)}
                </div>
                <div className="nav-group show">
                    <div className="nav-label" onClick={this.toggleMenu}>HR</div>
                    {this.populateMenu(pagesMenu)}
                </div>
                <div className="nav-group show">
                ...
                <div className="nav-group show">
                    <div className="nav-label" onClick={this.toggleMenu}>Attandance</div>
                    {this.populateMenu(AttandanceMenu)}
                </div> 
                <div className="nav-group show">
                    <div className="nav-label" onClick={this.toggleMenu}>Recrument</div>
                    {this.populateMenu(RecrutmentMenu)}
                </div> 
                <div className="nav-group show">
                    <div className="nav-label" onClick={this.toggleMenu}>Leave</div>
                    {this.populateMenu(LeaveMenu)}
                </div> 
                <div className="nav-group show">
                    <div className="nav-label" onClick={this.toggleMenu}>File Manager</div>
                    {/* {this.populateMenu(FileManagerMenu)} */}
                </div>
                <div className="nav-group show">
